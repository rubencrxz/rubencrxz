<div align="center">
  ...
  <p style="max-width:800px; font-size:clamp(48px, 6vw, 96px); color:#444;">
    I’m a smart contract security auditor that provides smart contract security assurance for production codebases, combining manual review, invariant testing and fuzzing.
  </p>
</div>
